...
factors:
  ...
  - Poseidon
  - Saturn
normalized_formula: Kronos/Poseidon = Saturn
...
- Formula: `Kronos/Poseidon = Saturn`
- Astronomicon formula: `¤/¨ = W`
- Axis page: [Kronos/Poseidon](../axes/kronos-poseidon.md)
- Triad hub: [Saturn Kronos Poseidon](../triads/saturn-kronos-poseidon.md)
