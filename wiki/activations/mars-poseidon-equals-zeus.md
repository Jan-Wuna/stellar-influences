...
factors:
  ...
  - Poseidon
  - Zeus
normalized_formula: Mars/Poseidon = Zeus
axis: Mars/Poseidon
activated_by: Zeus
triad_set:
  - Mars
...
- Formula: `Mars/Poseidon = Zeus`
- Astronomicon formula: `U/¨ = £`
- Axis page: [Mars/Poseidon](../axes/mars-poseidon.md)
- Triad hub: [Mars Zeus Poseidon](../triads/mars-zeus-poseidon.md)
