...
factors:
  ...
  - Mars
  - Venus
normalized_formula: Mercury/Mars = Venus
axis: Mercury/Mars
activated_by: Venus
triad_set:
  - Mercury
...
- Formula: `Mercury/Mars = Venus`
- Astronomicon formula: `T/U = Q`
...
To express ones love and values in a passionate manner. An appreciation of arguing, and the manner in which ideas conflict. Choosing a love with whom one can engage in verbal sparring, or mental stimulation.
