...
factors:
  ...
  - Poseidon
  - Mercury
normalized_formula: Pluto/Poseidon = Mercury
axis: Pluto/Poseidon
...
- Formula: `Pluto/Poseidon = Mercury`
- Astronomicon formula: `Z/¨ = T`
- Axis page: [Pluto/Poseidon](../axes/pluto-poseidon.md)
- Triad hub: [Mercury Pluto Poseidon](../triads/mercury-pluto-poseidon.md)
