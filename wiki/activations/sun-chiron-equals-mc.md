...
factors:
  ...
  - Chiron
  - MC
normalized_formula: Sun/Chiron = MC
axis: Sun/Chiron
activated_by: MC
triad_set:
  - Sun
...
- Formula: `Sun/Chiron = MC`
- Astronomicon formula: `S/Chiron = MC`
- Axis page: [Sun/Chiron](../axes/sun-chiron.md)
- Triad hub: [Sun Chiron MC](../triads/sun-chiron-mc.md)
