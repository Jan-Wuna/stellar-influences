...
factors:
  - Saturn
  - Pluto
normalized_axis: Saturn/Pluto
factor_a: Saturn
factor_b: Pluto
related_activations:
  - Saturn/Pluto = Admetos
  - Saturn/Pluto = Apollon
  - Saturn/Pluto = Asc
  - Saturn/Pluto = Chiron
  - Saturn/Pluto = Cupido
  - Saturn/Pluto = Hades
  ...
  - Saturn/Pluto = Node
  - Saturn/Pluto = Poseidon
  - Saturn/Pluto = Sun
  - Saturn/Pluto = Uranus
  - Saturn/Pluto = Venus
  - Saturn/Pluto = Vernal Point
...
+ Tenacity and toughness, endurance, capability to make record efforts of the highest possible order, ability to perform the roost difficult work with extreme self-discipline, self-denial and renunciation. Magicians and adepts. - A hard and unfeeling disposition, cold-hearted, severe, tendency to violence, fanatical adherence to one's principles once they have been adopted. A martyr. C Violence. (Mass murderer.)

#### Biological Correspondence

Organic underdevelopment (absence of testicle descensus, infantile organs, organic hardening or calcification processes). The following medical observation has been found: In the case of a lithopaedion (i.e., dried up or calcified foetus within the maternal body) the mother had the following mid-point configurations: Saturn/Pluto = Mars/Jupiter = Sun/MC, according to the practitioner, Dr. M.

#### Sociological Correspondence

Deeply searching scientists, reactionaries, violent people.

#### Probable Manifestations

+ Hard struggling for success, participation in achievements brought about by large groups or masses of people, the pursuit of difficult work or of painstaking and thorough research in seclusion, the pro- 55 The phrase "mass murder" has been frequently objected to. This was placed in brackets, meaning that it was of less immediate significance. It is only mentioned to point out that such combinations have sometimes been found, e.g., the chart of the mass murderer Haarmann, bom October 23, 1879, with Satum-45-Mars = Pluto. The same applies here as under 0866. As was stressed there, these combinations are only important if they are supported by other factors, in particular the personal points. cess of growing spiritually and mentally, silent activity. - Pursuit of purely egoistic aims, a person who is prevented by others from reaping the success due to him or her as the result of hard work. The application of force or of compulsion, self-destructive energy. The loss of one's fortune or possessions. Saturn/Pluto h/%
...
Spiritual matters press relentlessly on you, forcing you to grow - one way or another. Tremendous pressure that will inevitably lead to a breakthrough. Getting to the bottom of things. The transcending and transforming of limits. Going beyond the rules and laws one has set up for oneself. A person who is extremely serious, and often, even when they hide this, others pick up on it and are deeply affected by it, and sometimes feel intimidated. The breaking down of old structures and the forming of new ones.

#### Process

The progressive loss of the ability to avoid problems and challenges. The compulsion to return again and again to problems until they are truly and completely solved.
...
- Thesis: Reorganizing your priorities; the setting of more realistic goals; careful preparations for limiting the suspicions of others; endurance of activities designed to curb or correct past excesses or extreme practices.
- Anti: Disappointment with prior preparations; helps you take back commitments made previously; a loss of control or intensity; setting more rigid procedures with better official controls; despair over secret work.

#### In Your Relationships

- Thesis: Destroys habit patterns which hinder your relationships; adds a sense of seriousness to your sexual desires; a need for mutual self-discipline within the relationship; adding intensity and loyalty to commitment.
- Anti: A loss of intensity or desire between partners; added anguish when relating to partner, or vice-versa; strong tendencies toward miserliness or an unwillingness to share equally at any level in the relationship.

#### With Body or Mind

A loss or lessening of sexual desire; a lowering of functions from the pituitary gland; intensive pain or discomfort in the joints; shrinks hemorrhoids or piles.

#### In Politics or Business

- Thesis: Increased use of secret police or military agencies; restraints on destructive weapons; earth which blocks sewage systems; upsetting existing checks and balances; turmoil in any rigid or older structure.
- Anti: Keeping affairs private or not open to scrutiny secret preparations for future restrictions; the hoarding of resources for potential future disasters; lengthy consideration of methods of removal or destruction.
