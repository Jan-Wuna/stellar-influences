---
title: Vernal Point/Pluto
page_type: axis
slug: vernal-point-pluto
status: source_ingested
framework_scope: comparative
factors:
  - Vernal Point
  - Pluto
normalized_axis: Vernal Point/Pluto
factor_a: Vernal Point
factor_b: Pluto
related_activations:
  - Vernal Point/Pluto = MC
  - Vernal Point/Pluto = Asc
  - Vernal Point/Pluto = Sun
  - Vernal Point/Pluto = Moon
  - Vernal Point/Pluto = Node
  - Vernal Point/Pluto = Mercury
  - Vernal Point/Pluto = Venus
  - Vernal Point/Pluto = Mars
  - Vernal Point/Pluto = Jupiter
  - Vernal Point/Pluto = Saturn
  - Vernal Point/Pluto = Uranus
  - Vernal Point/Pluto = Neptune
...
- Axis: `Vernal Point/Pluto`
- Astronomicon axis: `VP/Z`
...
General changes, transformations or developments. General turnaround, alterations and modifications. A general boost to development. The world or general public in transformation. Immediate past of the general public. Plutocracy. Metamorphoses.

### Robert Hand - Horoscope Symbols

- Source heading: `Pluto/Aries`
- Source page: `213`

#### Pair Delineation

To be involved in, or the agent of, large-scale social transformations. To be lo^vn as one who brings about change, or as one with a ruthless ^vill. People involved in subversive, hidden, or underground activities.
