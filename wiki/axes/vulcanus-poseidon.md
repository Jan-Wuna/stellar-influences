---
title: Vulcanus/Poseidon
page_type: axis
slug: vulcanus-poseidon
status: source_ingested
framework_scope: comparative
factors:
  - Vulcanus
  - Poseidon
normalized_axis: Vulcanus/Poseidon
factor_a: Vulcanus
factor_b: Poseidon
related_activations:
  - Vulcanus/Poseidon = Admetos
  - Vulcanus/Poseidon = Apollon
  - Vulcanus/Poseidon = Asc
  - Vulcanus/Poseidon = Cupido
  - Vulcanus/Poseidon = Hades
  - Vulcanus/Poseidon = Jupiter
  - Vulcanus/Poseidon = Kronos
  - Vulcanus/Poseidon = Mars
  - Vulcanus/Poseidon = MC
  - Vulcanus/Poseidon = Mercury
  - Vulcanus/Poseidon = Moon
  - Vulcanus/Poseidon = Neptune
  - Vulcanus/Poseidon = Node
  - Vulcanus/Poseidon = Pluto
  - Vulcanus/Poseidon = Saturn
  - Vulcanus/Poseidon = Sun
  - Vulcanus/Poseidon = Uranus
  - Vulcanus/Poseidon = Venus
  - Vulcanus/Poseidon = Vernal Point
  - Vulcanus/Poseidon = Zeus
related_triad_hubs:
...
Influence of reason, influential idea, cognition power, spiritual energies, mental violence, spiritual power, influence of violence, power of wisdom, cultural influence, culture power, power of truth, and strong spirit
...
- This axis describes force guided by mind: power, pride, and self-command are filtered through mentality, producing a strong-willed, mentally influential stance that can read as dignified confidence or arrogance.
