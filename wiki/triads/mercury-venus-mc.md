...
- Triad-set: `Mercury Venus MC`
- Astronomicon triad-set: `T Q MC`
...
- `Mercury/MC = Venus`: Michael, page `184`
- `Mercury/Venus = MC`: Michael, page `148`
- `Venus/MC = Mercury`: Michael, page `220`
