...
- Triad-set: `Mercury Venus Uranus`
- Astronomicon triad-set: `T Q X`
...
- `Mercury/Uranus = Venus`: Michael, page `164`
- `Mercury/Venus = Uranus`: Michael, page `148`
- `Venus/Uranus = Mercury`: Michael, page `200`
