...
- Triad-set: `Venus Pluto Asc`
- Astronomicon triad-set: `Q Z Asc`
...
- `Pluto/Asc = Venus`: Michael, page `348`
- `Venus/Asc = Pluto`: Michael, page `216`
- `Venus/Pluto = Asc`: Michael, page `208`
